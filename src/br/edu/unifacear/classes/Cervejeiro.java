...
public class Cervejeiro implements IDBModel {
	...
	@ManyToMany
	@JoinTable(name = "Cervejeiro_Token", joinColumns = { @JoinColumn(name = "cevejeiro_id") }, inverseJoinColumns = {
			@JoinColumn(name = "token_id") })
	private List<Token> token;

	public Cervejeiro(int id, String nome, String senha, int idade, String email, String status, String telefone,

...
public class TelaPrincipalApreciador {
	...
	public void telaPrincipal() throws Exception {
		...
		btnGerenciarDados.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					TelaGerenciarDadosApreciador tgdApreciador = new TelaGerenciarDadosApreciador();
					tgdApreciador.telaGerenciarDadosApreciador();
				} catch (Exception e1) {
					e1.printStackTrace();
					return;
				}
		...
		btnDetalhesCerveja1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					detalhesCerveja.telaDetalhesCerveja(aprelike.get(0));
		...
		btnDetalhesCerveja2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					TelaDetalhesCerveja detalhesCerveja = new TelaDetalhesCerveja();
					detalhesCerveja.telaDetalhesCerveja(aprelike.get(1));
				} catch (Exception e1) {
		...
		btnDetalhesCerveja4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					TelaDetalhesCerveja detalhesCerveja = new TelaDetalhesCerveja();
					detalhesCerveja.telaDetalhesCerveja(aprelike.get(3));
				} catch (Exception e1) {
		...
		btnDetalhesCerveja3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					TelaDetalhesCerveja detalhesCerveja = new TelaDetalhesCerveja();
					detalhesCerveja.telaDetalhesCerveja(aprelike.get(2));
				} catch (Exception e1) {
